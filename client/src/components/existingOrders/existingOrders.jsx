...
const ExistingOrders=()=>{    
    ...
    const count=7
    const tableHeadings=["Order id", "Order Date & Time", "Store Location", "City", "Store Phone", "Total Items", "Price", "Status", "            ", "View"]
                        ...
                        {orders.map((order,index)=>{
                            ...
                            return (
                                <tr key={index} style={{backgroundColor: bgc}}>
                                    ...
                                    <td>
                                        <button className='table__button cancel'>cancel</button>
                                    </td>
                                    <td>
